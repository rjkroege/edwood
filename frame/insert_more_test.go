	...
	tests := []struct {
		...
		},
		{
			...
			want: []string{
				...
				"fill (44,70)-(44,85) [3,4],[0,1]",
				"blit (28,25)-(36,40) [1,1],[1,1], to (36,70)-(44,85) [2,4],[1,1]",
				"fill (28,25)-(44,40) [1,1],[2,1]",
				"fill (28,25)-(44,40) [1,1],[2,1]",
				"fill (20,40)-(44,70) [0,2],[3,2]",
				"fill (20,70)-(36,85) [0,4],[2,1]",
				`screen-800x600 <- string "a本" atpoint: (28,25) [1,1] fill: black`,
				`screen-800x600 <- string "ポポポ" atpoint: (20,40) [0,2] fill: black`,
				`screen-800x600 <- string "hel" atpoint: (20,55) [0,3] fill: black`,
				`screen-800x600 <- string "lo" atpoint: (20,70) [0,4] fill: black`,
			},
		},
		{
			...
			want: []string{
				...
				"fill (28,85)-(44,100) [1,5],[2,1]",
				"blit (36,70)-(44,85) [2,4],[1,1], to (20,85)-(28,100) [0,5],[1,1]",
				"blit (20,70)-(36,85) [0,4],[2,1], to (28,70)-(44,85) [1,4],[2,1]",
				"fill (44,70)-(44,85) [3,4],[0,1]",
				"blit (36,55)-(44,70) [2,3],[1,1], to (20,70)-(28,85) [0,4],[1,1]",
				"blit (20,55)-(36,70) [0,3],[2,1], to (28,55)-(44,70) [1,3],[2,1]",
				"fill (44,55)-(44,70) [3,3],[0,1]",
				"blit (36,40)-(44,55) [2,2],[1,1], to (20,55)-(28,70) [0,3],[1,1]",
				"blit (20,40)-(36,55) [0,2],[2,1], to (28,40)-(44,55) [1,2],[2,1]",
				"fill (44,40)-(44,55) [3,2],[0,1]",
				"blit (36,25)-(44,40) [2,1],[1,1], to (20,40)-(28,55) [0,2],[1,1]",
				"blit (28,25)-(36,40) [1,1],[1,1], to (36,25)-(44,40) [2,1],[1,1]",
