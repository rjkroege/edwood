...
// mockDumpableWindow is a mock implementation of DumpableWindow for testing.
...
func (m *mockDumpableWindow) BodyContent() ContentProvider {
	return ContentProviderFunc(func() string { return m.bodyContent })
}

func (m *mockDumpableWindow) TagContent() ContentProvider {
	return ContentProviderFunc(func() string { return m.tagContent })
}
...
func TestContentProviderInterface(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			provider := ContentProviderFunc(func() string {
				return tc.content
			})
...
func TestWindowDumperCreation(t *testing.T) {
	dumper := NewWindowDumper(&DefaultTagParser{})
...
func TestTagRestorerInterface(t *testing.T) {
	restorer := NewTagRestorer(&DefaultTagParser{})
...
func TestTagParseError(t *testing.T) {
	err := &TagParseError{Tag: "bad tag", Reason: "missing delimiter"}
	expected := "bad window tag: missing delimiter: bad tag"
